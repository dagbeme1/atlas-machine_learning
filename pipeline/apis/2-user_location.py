...
Returns:
    ...
    Prints "Reset in X min" if the GitHub API rate limit is
    exceeded, where X is the time until reset.
...
if __name__ == '__main__':
    ...
    if response.status_code == 200:
        ...
        # Print the user's location if available; otherwise, print default
        # message
