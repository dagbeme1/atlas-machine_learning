...
def display_animation(frames_dir):
    ...
    frames = [plt.imread(frame_path) for frame_path in frame_paths]
...
#scores = train(env, 500, 0.000045, 0.98)

# Optionally, uncomment the following lines to run the second training session
# scores = train(env, 1000, 0.000045, 0.98, True)
