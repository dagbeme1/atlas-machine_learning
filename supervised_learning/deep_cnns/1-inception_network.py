...
# Importing the Keras module from TensorFlow with the alias 'K'.

inception_block = __import__('0-inception_block').inception_block
# Importing the 'inception_block' function from the '0-inception_block' module

from custom_inception_blocks import my_inception_block
# Importing the custom_inception_block function
# from the custom_inception_blocks module.
...
def create_custom_inception_network():
    ...
    # a stride of (2, 2), 'same' padding, and
    ...
    X = my_inception_block(X, [64, 96, 128, 16, 32, 32])
    # Adding a custom inception block with the provided
    # filter configuration to the previous layer.

    # Several more custom inception blocks are added
    # with different filter configurations.
