...
ubuntu@alexa-ml:~/optimization$ cat 0-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print(m)
    print(s)
ubuntu@alexa-ml:~/optimization$ ./0-main.py 
[ 0.11961603  2.08201297 -3.59232261]
[2.01576449 1.034667   9.52002619]
ubuntu@alexa-ml:~/optimization$
Repo:
...
ubuntu@alexa-ml:~/optimization$ cat 1-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print(m)
    print(s)
ubuntu@alexa-ml:~/optimization$ ./1-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 2-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print(X_shuffled)
    print(Y_shuffled)
ubuntu@alexa-ml:~/optimization$ ./2-main.py 
[[ 5  6]
 [ 1  2]
 [ 3  4]
 [ 7  8]
...
ubuntu@alexa-ml:~/optimization$ cat 3-main.py
#!/usr/bin/env python3
...
ubuntu@alexa-ml:~/optimization$ ./3-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 4-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
        ...
        plt.show()
ubuntu@alexa-ml:~/optimization$ ./4-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 5-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./5-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 6-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./6-main.py 
...
Returns: the updated variable and the new moment, respectively
ubuntu@alexa-ml:~/optimization$ cat 7-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./7-main.py 
Cost after 0 iterations: 4.365105010037203
...
ubuntu@alexa-ml:~/optimization$ cat 8-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./8-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 9-main.py
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./9-main.py
Cost after 0 iterations: 4.365105010037203
...
ubuntu@alexa-ml:~/optimization$ cat 10-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.show()
ubuntu@alexa-ml:~/optimization$ ./10-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 11-main.py
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    for i in range(100):
        ...
        print(alpha)
ubuntu@alexa-ml:~/optimization$ ./11-main.py
0.1
0.1
0.1
0.1
...
ubuntu@alexa-ml:~/optimization$ cat 12-main.py
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for i in range(100):
            ...
            print(a)
            sess.run(train_op, feed_dict={x:X, y:Y_oh})
ubuntu@alexa-ml:~/optimization$ ./12-main.py
...
ubuntu@alexa-ml:~/optimization$ cat 13-main.py 
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print(Z_norm[:10])
ubuntu@alexa-ml:~/optimization$ ./13-main.py 
[[  3.52810469   3.8831507   -6.69181838]
 [  0.80031442   0.65224094  -5.39379178]
 [  1.95747597   0.729515     7.99659596]
 [  4.4817864    2.96939671   3.55263731]
...
ubuntu@alexa-ml:~/optimization$ cat 14-main.py 
#!/usr/bin/env python3
...
ubuntu@alexa-ml:~/optimization$ ./14-main.py 
...
ubuntu@alexa-ml:~/optimization$ cat 15-main.py
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print('Model saved in path: {}'.format(save_path))
ubuntu@alexa-ml:~/optimization$ ./15-main.py 
After 0 epochs:
