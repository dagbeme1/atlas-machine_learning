...
def main():
    ...
    bitstamp_preprocessed_data_v = np.load(
        'bitstamp_preprocessed_data.csv.npy')
    # Convert the NumPy array to a pandas DataFrame
    bitstamp_preprocessed_data_v_df = pd.DataFrame(
        bitstamp_preprocessed_data_v, columns=['Close'])

    coinbase_preprocessed_data_v = np.load(
        'coinbase_preprocessed_data.csv.npy')
    # Convert the NumPy array to a pandas DataFrame
    coinbase_preprocessed_data_v_df = pd.DataFrame(
        coinbase_preprocessed_data_v, columns=['Close'])
    ...
    print("Bitstamp preprocessed data has NaN values:",
          pd.isna(bitstamp_preprocessed_data_v_df).any().any())
    ...
    print("Coinbase preprocessed data has NaN values:",
          pd.isna(coinbase_preprocessed_data_v_df).any().any())
